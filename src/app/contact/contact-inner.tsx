      ...
      <section className="contact-section">
        <div className="contact-grid">
          <div className="contact-info">
            <h2>Get In Touch</h2>
            <p><strong>Email:</strong><br /> info@srikandibakoh.com</p>
            <p><strong>Phone (Office):</strong><br /> +62 851 5901 7001</p>
            <p>
            ...
            <p>
              ...
              Jl. Raya Jenangan No.129, Krajan II, Jimbe,<br />
              Kec. Jenangan, Kabupaten Ponorogo,<br />
              Jawa Timur 63492
            </p>
          </div>
          ...
          <div className="contact-form">
            ...
            <form onSubmit={handleSubmit} noValidate>
              ...
              {errors.name && <div style={{ color: "#b91c1c", fontSize: "0.9rem" }}>{errors.name}</div>}
              ...
              {errors.email && <div style={{ color: "#b91c1c", fontSize: "0.9rem" }}>{errors.email}</div>}
              ...
              {errors.phone && <div style={{ color: "#b91c1c", fontSize: "0.9rem" }}>{errors.phone}</div>}
              ...
              {errors.message && <div style={{ color: "#b91c1c", fontSize: "0.9rem" }}>{errors.message}</div>}
